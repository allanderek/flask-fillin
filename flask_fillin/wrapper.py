...
class FormWrapper(Response):
    ...
    def links(self, css_expression="a"):
        ...
        links = self.html.cssselect(css_expression)

        # add click function to all links, note that this is supposed
        # to be done in 'self.html', however I found that cssselect was
        # producing new elements rather than using the already parsed ones,
        # hence, the _click method was not being added to those newly
